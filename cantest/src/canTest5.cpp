...
struct LinkSys{
	...
	float angle1Ini = 105/180*M_PI;
	float angle2Ini = -15/180*M_PI;
};
LinkSys linksys;
...
void calLinkSysangleFromXY(LinkSys linksys,float x,float y)
{
	...
	LinkSys linksys2;
	calLinkSysXYFromAngle(linksys2,linksys.angle11,linksys.angle21);
	linksys.err1 = sqrt(pow((linksys2.x-linksys.x),2)+pow((linksys2.y-linksys.y),2));
	calLinkSysXYFromAngle(linksys2,linksys.angle12,linksys.angle22);
	linksys.err2 = sqrt(pow((linksys2.x-linksys.x),2)+pow((linksys2.y-linksys.y),2));
...
{
	linksys.angle1 = linksys.angle1Ini + linksys.z1/linksys.z2*(motor1.position - motor1.positionIni);
	linksys.angle2 = linksys.angle1Ini + linksys.z1/linksys.z2*(motor2.position - motor2.positionIni);
}

void linkAngle2motorPosition(LinkSys linksys,Motor motor1,Motor motor2)
{
	motor1.position = motor1.positionIni + linksys.z2/linksys.z1*(linksys.angle1 - linksys.angle1Ini);
	motor2.position = motor2.positionIni + linksys.z2/linksys.z1*(linksys.angle2 - linksys.angle1Ini);
}
		...
		if(i%4==0)
		{
			switch (mode)
			{
				...
				case 7:
					printf("mode is %d; ",mode);
					printf("limitmotor0 is %d %d;",motor[0].limit_0,motor[0].limit_1);
					printf("limitmotor1 is %d %d\n",motor[1].limit_0,motor[1].limit_1);
				default:
					mode = 0;
